...
public class PersonalLoadoutGuiDetails : MonoBehaviour
{
    public static PersonalLoadoutGuiDetails? m_instance;
    ...
    public static void LoadLoadout(string loadoutName)
    {
        ...
        {
            PersonalLoadoutDetails loadout = PersonalLoadoutDetails.Deserialize(loadoutName, serializedData);
    ...
    private static void EquipItemsFromLoadout(Player player, PersonalLoadoutDetails loadout)
    {
    ...
    public void UpdateSwitchLoadoutButton()
    {
        ...
        if (m_selectedItem != null)
        {
            ...
            PersonalLoadoutDetails selectedLoadout = PersonalLoadoutDetails.Deserialize(m_selectedItem, serializedData);
...
public class PersonalLoadoutDetails
{
    public string LoadoutName { get; set; }
    public List<ItemDrop.ItemData> Items { get; set; }

    public PersonalLoadoutDetails(string loadoutName, List<ItemDrop.ItemData> items)
    {
    ...
    public static PersonalLoadoutDetails Deserialize(string loadoutName, string data)
    {
        Inventory tempInventory = new("Loadout", null, 100, 100);
        InventorySerializer.DeserializeInventory(tempInventory, data);
        List<ItemDrop.ItemData> items = tempInventory.GetAllItems();
        return new PersonalLoadoutDetails(loadoutName, items);
    }
}